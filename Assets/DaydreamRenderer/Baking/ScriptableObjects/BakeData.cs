...
namespace daydreamrenderer
{
    ...
    public class BakeData : ScriptableObject
    {
        ...
        public DaydreamRendererImportSettings GetImportSettings()
        {
            ...
            {
                m_importSettings = new DaydreamRendererImportSettings();
                m_importSettings.name = "ImportSettings";
                AssetDatabase.AddObjectToAsset(m_importSettings, DataPath + "/BakeData.asset");
        ...
        public void SaveImportSettings()
        {
            ...
            if (m_importSettings != null)
            {
                EditorUtility.SetDirty(m_importSettings);
                AssetDatabase.SaveAssets();
            }
#endif
        }
