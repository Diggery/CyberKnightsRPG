...
namespace daydreamrenderer
{
    ...
    class DaydreamRendererImportManager : EditorWindow
    {
        ...
        static class Styles
        {
            ...
            public const string kToggleComponentsHelp = "Daydream Renderer utilizes a custom lighting system that requires these components in order to provide lighting data to shaders";
            static Styles()
            {
