...
namespace daydreamrenderer
{
...
#else
        public const string LIBNAME = "Assets\\Plugins\\baker\\x86_64\\daydreambaker\\daydreambaker.dll";
#endif
    ...
    IntPtr _BuildBVH(IntPtr meshIds, IntPtr vertexCounts, IntPtr triangleCountPtr, IntPtr matData
            , IntPtr mesh, IntPtr triangles, IntPtr bakeOptions, int meshCount, [In] string[] guids
    ...
    int _RebuildBVH(IntPtr bvhHandle, IntPtr meshIds, IntPtr vertexCounts, IntPtr triangleCountPtr, IntPtr matData
            , IntPtr mesh, IntPtr triangles, IntPtr bakeOptions, int meshCount, [In] string[] guids, [In] string[] sourcePaths);
        #endregion
    ...
    int _RayToIndex(IntPtr bvhSceneHandle, float[] startPoint, float[] endPoint, [In, Out] int[] outIndex);
        ...
        private static extern
#endif
     bool _TessellateTriangles(IntPtr bvhhandle, IntPtr meshId, IntPtr vertexCount, IntPtr triangleCount, int elementCount, [In] BakeContext.Element[] vertFormat, IntPtr mat, IntPtr meshData
                                , IntPtr triangles, IntPtr bakeOptions, [In] string[] guid, [In] string[] sourcePaths, IntPtr[] settingsFB);
        #endregion
    ...
    private delegate
        ...
        private static extern
#endif
    int _OccludersAtVertex(IntPtr bvhHandle, int vertex, Vector3 worldPos, Vector3 worldNormal, [In, Out] IntPtr[] testPoints, [In, Out] int[] pointsCount
